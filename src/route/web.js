...
router.get('/api/get-detail-specialty-by-id',specialtyController.getDetailSpecialtyById)
    ...
    router.post('/api/create-new-clinic', clinicsController.createClinic);
    router.get('/api/get-clinic',clinicsController.getAllClinic);
    router.get('/api/get-detail-clinic-by-id',clinicsController.getDetailClinictyById)
